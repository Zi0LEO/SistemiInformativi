...
public abstract class BaseAmministratorePeerImpl
    extends org.apache.torque.util.AbstractPeerImpl<Amministratore>
{
    /** Serial version */
    private static final long serialVersionUID = 1741873522726L;
     ...
     * initialized.
     */
    public BaseAmministratorePeerImpl()
    {
        this(new AmministratoreRecordMapper(),
            AmministratorePeer.TABLE,
            AmministratorePeer.DATABASE_NAME);
    }
     ...
     */
    public BaseAmministratorePeerImpl(
            RecordMapper<Amministratore> recordMapper, 
            TableMap tableMap,
            String databaseName)
    {
     ...
     */
    public Amministratore getDbObjectInstance()
    {
        ...
        throws TorqueException
    {
...

        {
            JdbcTypedValue pkValue
                = columnValues.remove(AmministratorePeer.EMAIL);
            if (pkValue == null)
            {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public int doDelete(Amministratore obj) throws TorqueException
    {
     ...
     * doDelete(Amministratore) method.
     *
     * @param obj the data object to delete in the database, not null.
     * @param con the connection to use, not null.
     *
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public int doDelete(Amministratore obj, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public int doDelete(Collection<Amministratore> objects)
            throws TorqueException
    {
    ...
    public Criteria buildCriteria(ObjectKey<?> pk)
    {
        ...
        criteria.and(AmministratorePeer.EMAIL, pk);
        return criteria;
     }
    ...
    {
        Criteria criteria = new Criteria();
        criteria.andIn(AmministratorePeer.EMAIL, pks);
        return criteria;
     }
     ...
     */
    public Criteria buildCriteria(Amministratore obj)
    {
        Criteria criteria = new Criteria(getDatabaseName());
        if (!obj.isNew())
        {
            criteria.and(AmministratorePeer.EMAIL, obj.getEmail());
        }
        return criteria;
    }
     ...
     * @param obj the object to build the criteria from, not null.
     */
    public Criteria buildSelectCriteria(Amministratore obj)
    {
        Criteria criteria = new Criteria(getDatabaseName());
        if (!obj.isNew())
        {
     ...
     *         (should not happen).
     */
    public ColumnValues buildColumnValues(Amministratore amministratore)
            throws TorqueException
    {
        ColumnValues columnValues = new ColumnValues();
        if (!amministratore.isNew() 
            || amministratore.getEmail() != null)
        {
            columnValues.put(
                    AmministratorePeer.EMAIL,
                    new JdbcTypedValue(
     ...
     */
    public Amministratore retrieveByPK(String pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public Amministratore retrieveByPK(String pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public Amministratore retrieveByPK(ObjectKey<?> pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        try (TorqueConnection connection = Transaction.begin(getDatabaseName()))
        {
            Amministratore result = retrieveByPK(pk, connection);
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public Amministratore retrieveByPK(ObjectKey<?> pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        Amministratore v = doSelectSingleRecord(criteria, con);
        if (v == null)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public List<Amministratore> retrieveByTypedPKs(Collection<String> pks)
        throws TorqueException
    {
        try (TorqueConnection connection = Transaction.begin(getDatabaseName()))
        {
            List<Amministratore> result = retrieveByTypedPKs(pks, connection);
            Transaction.commit(connection);
            return result;
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public List<Amministratore> retrieveByTypedPKs(
            ...
            throws TorqueException
    {
        ...
        {
            return new ArrayList<Amministratore>();
        }
        ...
        List<Amministratore> result = doSelect(criteria, dbcon);
        return result;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public List<Amministratore> retrieveByObjectKeys(Collection<ObjectKey<?>> pks)
        throws TorqueException
    {
        try (TorqueConnection connection = Transaction.begin(getDatabaseName()))
        {
            List<Amministratore> result = retrieveByObjectKeys(pks, connection);
            Transaction.commit(connection);
            return result;
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public List<Amministratore> retrieveByObjectKeys(
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public List<Amministratore> doSelectJoinUtente(Criteria criteria)
        throws TorqueException
    {
        try (TorqueConnection connection = Transaction.begin(getDatabaseName()))
        {
            List<Amministratore> result
                    = AmministratorePeer.doSelectJoinUtente(criteria, connection);
            Transaction.commit(connection);
            return result;
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public List<Amministratore> doSelectJoinUtente(
        ...
        throws TorqueException
    {
        ...
        compositeMapper.addMapper(
                new AmministratoreRecordMapper(),
                0);
        compositeMapper.addMapper(
                new UtenteRecordMapper(),
                AmministratorePeer.numColumns);
        criteria.addJoin(AmministratorePeer.EMAIL,
            com.opcal.UtentePeer.EMAIL);

        correctBooleans(criteria);

        List<Amministratore> result = new ArrayList<Amministratore>();
        List<List<Object>> rawResult = doSelect(
                criteria, compositeMapper, conn);
        for (List<Object> rawResultRow : rawResult)
        {
            Amministratore obj1 = (Amministratore) rawResultRow.get(0);
            Utente obj2 = (Utente) rawResultRow.get(1);

            boolean newObject = true;
            for (int j = 0; j < result.size(); j++)
            {
                Amministratore temp_obj1 = result.get(j);
                com.opcal.Utente temp_obj2 = temp_obj1.getUtente();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addAmministratore(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initAmministratores();
                obj2.addAmministratore(obj1);
            }
            result.add(obj1);
        }
        return result;
