 ...
 * extended; all references should be to InCorso
 */
@SuppressWarnings("unused")
public abstract class BaseInCorso 
    implements Persistent, Serializable, ColumnAccessByName
{
    /** Serial version */
    private static final long serialVersionUID = 1741873521597L;
    ...
    {
        if (com.opcal.InCorsoPeer.CODICE.getSqlExpression().equals(name)
            || com.opcal.InCorsoPeer.CODICE.getColumnName().equals(name))
        {
            return getCodice();
        }
        if (com.opcal.InCorsoPeer.DATA_SPEDIZIONE.getSqlExpression().equals(name)
            || com.opcal.InCorsoPeer.DATA_SPEDIZIONE.getColumnName().equals(name))
        {
            return getDataSpedizione();
        }
        if (com.opcal.InCorsoPeer.STATO.getSqlExpression().equals(name)
            || com.opcal.InCorsoPeer.STATO.getColumnName().equals(name))
        {
            return getStato();
        }
        return null;
    ...
    {
        save(InCorsoPeer.DATABASE_NAME);
    }
            ...
            throws TorqueException
    {
        ...
        try
        {
            ...
            if (isModified())
            {
                if (isNew())
                {
                    InCorsoPeer.doInsert((InCorso) this, con);
                    setNew(false);
                }
                else
                {
                    InCorsoPeer.doUpdate((InCorso) this, con);
                }
            }
     ...
     */
    public InCorso copy() throws TorqueException
    {
        return copy(true);
    }
     ...
     * @throws TorqueException if retrieval of the associated objects fails     
     */
    public InCorso copy(Connection con) throws TorqueException
    {
     ...
     * @throws TorqueException if retrieval of the associated objects fails
     */
    public InCorso copy(boolean deepcopy) throws TorqueException
    {
        InCorso inCorso = new InCorso();

        return copyInto(inCorso, deepcopy);
    }
     ...
     * @throws TorqueException if retrieval of the associated objects fails
     */
    public InCorso copy(boolean deepcopy, Connection con) throws TorqueException
    {
        InCorso inCorso = new InCorso();

        return copyInto(inCorso, deepcopy, con);
    }
     ...
     * @throws TorqueException if retrieval of the associated objects fails
     */
    public InCorso copyInto(InCorso copyObj) throws TorqueException
    {
     ...
     * @throws TorqueException if retrieval of the associated objects fails
     */
    public InCorso copyInto(InCorso copyObj, Connection con) throws TorqueException
    {
     ...
     * @throws TorqueException if retrieval of the associated objects fails
     */
    protected InCorso copyInto(InCorso copyObj, boolean deepcopy) throws TorqueException
    {
     ...
     * @throws TorqueException if retrieval of the associated objects fails
     */
    public InCorso copyInto(InCorso copyObj, boolean deepcopy, Connection con) throws TorqueException
    {
        copyObj.setCodice((String) null);
        copyObj.setDataSpedizione(dataSpedizione);
        copyObj.setStato(stato);
    ...
    /** The Peer class */
    private static final com.opcal.InCorsoPeer peer
            = new com.opcal.InCorsoPeer();
     ...
     */
    public com.opcal.InCorsoPeer getPeer()
    {
        return peer;
    }
    ...
    {
        return com.opcal.InCorsoPeer.getTableMap();
    }
    ...
    public boolean equals(Object toCompare)
    {
        ...
        InCorso other = (InCorso) toCompare;
     ...
     */
    public boolean valueEquals(InCorso toCompare)
    {
        if (toCompare == null)
        {
            return false;
