...
public class BaseAmministratoreRecordMapper implements RecordMapper<Amministratore>
{
    /** Serial version */
    private static final long serialVersionUID = 1741873523072L;

    /** The class log. */
    private static Log log
            = LogFactory.getLog(BaseAmministratoreRecordMapper.class);
     ...
     *         than the columns in the amministratore table.
     */
    public Amministratore processRow(
                ResultSet resultSet,
                int offset,
                Criteria criteria)
            throws TorqueException
    {
        ...
        try 
        {
            amministratore.setLoading(true);
            if (criteria == null)
            {
                amministratore.setEmail(
            ...
            else
            {
                ...
                {
                    if (BaseAmministratorePeer.EMAIL.getSqlExpression().equals(
            ...
            amministratore.setNew(false);
            amministratore.setModified(false);
        }
        finally
        {
            amministratore.setLoading(false);
        }
     ...
     * the field email in Amministratore.
     *
