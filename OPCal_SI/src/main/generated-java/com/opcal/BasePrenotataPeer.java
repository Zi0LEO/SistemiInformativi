 ...
 * extended; all references should be to PrenotataPeer
 */

@SuppressWarnings("unused")
public abstract class BasePrenotataPeer
{
    ...
    /** The column for the data_ritiro field */
    public static final ColumnMap DATA_RITIRO;
    /** The column for the data_prenotazione field */
    public static final ColumnMap DATA_PRENOTAZIONE;
    ...
    private static PrenotataPeerImpl prenotataPeerImpl;
    ...
    static
    {
        DatabaseMap dbMap = Torque.getOrCreateDatabase("opcal")
                .getDatabaseMap();
        if (dbMap.getTable("prenotata") == null)
        {
            dbMap.addTable("prenotata");
        }
        DATABASE_NAME = "opcal";
        TABLE_NAME = "prenotata";

        TABLE = dbMap.getTable("prenotata");
        TABLE.setJavaName("Prenotata");
        TABLE.setOMClass(com.opcal.Prenotata.class);
        TABLE.setPeerClass(com.opcal.PrenotataPeer.class);
        TABLE.setDescription("Spedizioni in attesa di ritiro");
        TABLE.setPrimaryKeyMethod(IDMethod.NATIVE);
        TABLE.setPrimaryKeyMethodInfo(IDMethod.ID_BROKER, TABLE.getName());
        TABLE.setPrimaryKeyMethodInfo(IDMethod.SEQUENCE, "prenotata_SEQ");
        TABLE.setPrimaryKeyMethodInfo(IDMethod.AUTO_INCREMENT, "prenotata");
    ...
    // ------------- Column: data_ritiro --------------------
        DATA_RITIRO = new ColumnMap("data_ritiro", TABLE);
        DATA_RITIRO.setType(new Date());
        DATA_RITIRO.setTorqueType("DATE");
        DATA_RITIRO.setUsePrimitive(false);
        DATA_RITIRO.setPrimaryKey(false);
        DATA_RITIRO.setNotNull(true);
        DATA_RITIRO.setJavaName("DataRitiro");
        DATA_RITIRO.setAutoIncrement(true);
        DATA_RITIRO.setProtected(false);
        DATA_RITIRO.setJavaType( "java.util.Date" );
        DATA_RITIRO.setDescription("Data prevista di ritiro");
        DATA_RITIRO.setSize(255);
        DATA_RITIRO.setPosition(2);
        TABLE.addColumn(DATA_RITIRO);
    // ------------- Column: data_prenotazione --------------------
        DATA_PRENOTAZIONE = new ColumnMap("data_prenotazione", TABLE);
        DATA_PRENOTAZIONE.setType(new Date());
        DATA_PRENOTAZIONE.setTorqueType("DATE");
        DATA_PRENOTAZIONE.setUsePrimitive(false);
        DATA_PRENOTAZIONE.setPrimaryKey(false);
        DATA_PRENOTAZIONE.setNotNull(true);
        DATA_PRENOTAZIONE.setJavaName("DataPrenotazione");
        DATA_PRENOTAZIONE.setAutoIncrement(true);
        DATA_PRENOTAZIONE.setProtected(false);
        DATA_PRENOTAZIONE.setJavaType( "java.util.Date" );
        DATA_PRENOTAZIONE.setDescription("Data di prenotazione della spedizione");
        DATA_PRENOTAZIONE.setSize(255);
        DATA_PRENOTAZIONE.setPosition(3);
        TABLE.addColumn(DATA_PRENOTAZIONE);
     ...
     */
    protected static PrenotataPeerImpl createPrenotataPeerImpl()
    {
        PrenotataPeerImpl instance = new PrenotataPeerImpl();
        return instance;
    }
     ...
     */
    public static PrenotataPeerImpl getPrenotataPeerImpl()
    {
        PrenotataPeerImpl peerImplInstance = prenotataPeerImpl;
        if (peerImplInstance == null)
        {
            peerImplInstance = PrenotataPeer.createPrenotataPeerImpl();
            prenotataPeerImpl = peerImplInstance;
            Torque.registerPeerInstance(Prenotata.class, peerImplInstance);
        }
     ...
     */
    public static void setPrenotataPeerImpl(PrenotataPeerImpl peerImplInstance)
    {
        prenotataPeerImpl = peerImplInstance;
    }
    ...
    {
        getPrenotataPeerImpl().addSelectColumns(criteria);
    }
    ...
    {
        getPrenotataPeerImpl().correctBooleans(criteria);
    }
    ...
    {
        getPrenotataPeerImpl().correctBooleans(columnValues);
    }
    
    /**
     * Selects Prenotata objects from a database.
     *
     ...
     */
    public static List<Prenotata> doSelect(Criteria criteria)
            throws TorqueException
    {
        return getPrenotataPeerImpl().doSelect(criteria);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Prenotata> doSelect(
                Criteria criteria,
                Connection connection)
            throws TorqueException
    {
        return getPrenotataPeerImpl().doSelect(criteria, connection);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static Stream<Prenotata> doSelectAsStream(
                Criteria criteria,
                Connection connection)
            throws TorqueException
    {
        return getPrenotataPeerImpl().doSelectAsStream(criteria, connection);
    }
    ...
    public static <T> List<T> doSelect(
            ...
            throws TorqueException
    {
        return getPrenotataPeerImpl().doSelect(criteria, mapper);
    }
    ...
    public static <T> List<T> doSelect(
        ...
        throws TorqueException
    {
        return getPrenotataPeerImpl().doSelect(
                criteria,
                mapper,
                connection);
    }
    ...
    public static <T> Stream<T> doSelectAsStream(
        ...
        throws TorqueException
    {
        return getPrenotataPeerImpl().doSelectAsStream(
                criteria,
                mapper,
                connection);
    }
    ...
    /**
     * Selects Prenotata objects from the database which have
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Prenotata> doSelect(Prenotata obj)
            throws TorqueException
    {
        return getPrenotataPeerImpl().doSelect(obj);
    }

    /**
     * Selects at most one Prenotata object from a database.
     *
     * @param criteria object used to create the SELECT statement.
     *
     ...
     */
    public static Prenotata doSelectSingleRecord(
                Criteria criteria)
            throws TorqueException
    {
        return getPrenotataPeerImpl().doSelectSingleRecord(criteria);
    }
    ...
    public static Prenotata doSelectSingleRecord(
            ...
            throws TorqueException
    {
        return getPrenotataPeerImpl().doSelectSingleRecord(criteria, connection);
    }
    ...
    public static <T> T doSelectSingleRecord(
            ...
            throws TorqueException
    {
        return getPrenotataPeerImpl().doSelectSingleRecord(
                criteria,
                mapper);
    }
    ...
    /**
     * Selects at most one Prenotata object from the database
    ...
    public static Prenotata doSelectSingleRecord(
            ...
            throws TorqueException
    {
        return getPrenotataPeerImpl().doSelectSingleRecord(obj);
    }
     ...
     */
    public static Prenotata getDbObjectInstance()
    {
        return getPrenotataPeerImpl().getDbObjectInstance();
    }
    ...
    public static ObjectKey<?> doInsert(ColumnValues columnValues) 
            throws TorqueException
    {
        return getPrenotataPeerImpl().doInsert(columnValues);
    }
    ...
    public static ObjectKey<?> doInsert(ColumnValues columnValues, Connection con)
            throws TorqueException
    {
        return getPrenotataPeerImpl().doInsert(columnValues, con);
    }
    /**
     * Method to do inserts
     *
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(Prenotata obj)
            throws TorqueException
    {
        getPrenotataPeerImpl().doInsert(obj);
    }

    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(Prenotata) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(Prenotata obj, Connection con)
            throws TorqueException
    {
        getPrenotataPeerImpl().doInsert(obj, con);
    }
    ...
    public static int doInsert(
            ...
            throws TorqueException
    {
        return getPrenotataPeerImpl().doInsert(toInsertInto, criteria);
    }
    ...
    public static int doInsert(
            ...
            throws TorqueException
    {
        return getPrenotataPeerImpl().doInsert(toInsertInto, criteria, dbName);
    }
    ...
    public static int doInsert(
            ...
            throws TorqueException
    {
        return getPrenotataPeerImpl().doInsert(toInsertInto, criteria, connection);
    }
    ...
    public static int doInsert(
            ...
            throws TorqueException
    {
        return getPrenotataPeerImpl().doInsert(
                 toInsertInto,
                 criteria,
                 dbName,
                 connection);
    ...
    {
        return getPrenotataPeerImpl().doUpdate(columnValues);
    }
    ...
    public static int doUpdate(ColumnValues columnValues, Connection con)
        throws TorqueException
    {
        return getPrenotataPeerImpl().doUpdate(columnValues, con);
    }
    ...
    public static int doUpdate(
            ...
            throws TorqueException
    {
        return getPrenotataPeerImpl().doUpdate(
            selectCriteria,
            updateValues);
    }
    ...
    /**
     * Updates an Prenotata in the database.
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static int doUpdate(Prenotata obj) throws TorqueException
    {
        return getPrenotataPeerImpl().doUpdate(obj);
    }

    /**
     * Updates a Prenotata in the database.
     * The primary key is used to identify the object to update.
     * This method is to be used during a transaction,
     * otherwise the doUpdate(Prenotata) method can be used.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use, not null.
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static int doUpdate(Prenotata obj, Connection con)
        throws TorqueException
    {
        return getPrenotataPeerImpl().doUpdate(obj, con);
    }
    ...
    public static int executeStatement(String statementString) 
            throws TorqueException
    {
        return getPrenotataPeerImpl().executeStatement(statementString);
    }
    ...
    public static int executeStatement(
            ...
            throws TorqueException
    {
        return getPrenotataPeerImpl().executeStatement(
                statementString, 
                replacementValues);
    }
     ...
     */
     ...
     {
        return getPrenotataPeerImpl().doDelete(criteria);
     }
    ...
    *
     ...
     */
     public static int doDelete(Criteria criteria, Connection con)
        throws TorqueException
     {
        return getPrenotataPeerImpl().doDelete(criteria, con);
     }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static int doDelete(Prenotata obj) throws TorqueException
    {
        return getPrenotataPeerImpl().doDelete(obj);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static int doDelete(Prenotata obj, Connection con)
        throws TorqueException
    {
        return getPrenotataPeerImpl().doDelete(obj, con);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static int doDelete(Collection<Prenotata> objects)
            throws TorqueException
    {
        return getPrenotataPeerImpl().doDelete(objects);
    }
    ...
    public static int doDelete(
            Collection<Prenotata> objects,
            Connection con)
        throws TorqueException
    {
        return getPrenotataPeerImpl().doDelete(objects, con);
    }
    ...
    {
        return getPrenotataPeerImpl().doDelete(pk);
    }
    ...
    public static int doDelete(ObjectKey<?> pk, Connection con)
        throws TorqueException
    {
        return getPrenotataPeerImpl().doDelete(pk, con);
    }
    ...
    {
        return getPrenotataPeerImpl().buildCriteria(pk);
    }
    ...
    {
        return getPrenotataPeerImpl().buildCriteria(pks);
    }
    ...
    public static Criteria buildPkCriteria(
            Collection<Prenotata> objects)
    {
        return getPrenotataPeerImpl().buildPkCriteria(objects);
    }
     ...
     */
    public static Criteria buildCriteria(Prenotata obj)
    {
        return getPrenotataPeerImpl().buildCriteria(obj);
    }
     ...
     * @param obj the object to build the criteria from, not null.
     */
    public static Criteria buildSelectCriteria(Prenotata obj)
    {
        return getPrenotataPeerImpl().buildSelectCriteria(obj);
    }
     ...
     *         (should not happen).
     */
    public static ColumnValues buildColumnValues(Prenotata prenotata)
            throws TorqueException
    {
        
        return getPrenotataPeerImpl().buildColumnValues(prenotata);
    }
     ...
     */
    public static Prenotata retrieveByPK(String pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        return getPrenotataPeerImpl().retrieveByPK(pk);
    }
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static Prenotata retrieveByPK(String pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        return getPrenotataPeerImpl().retrieveByPK(pk, con);
    }
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static Prenotata retrieveByPK(ObjectKey<?> pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        return getPrenotataPeerImpl().retrieveByPK(pk);
    }
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static Prenotata retrieveByPK(ObjectKey<?> pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        return getPrenotataPeerImpl().retrieveByPK(pk, con);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Prenotata> retrieveByTypedPKs(Collection<String> pks)
        throws TorqueException
    {
        return getPrenotataPeerImpl().retrieveByTypedPKs(pks);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Prenotata> retrieveByTypedPKs(
                Collection<String> pks,
                Connection dbcon)
            throws TorqueException
    {
        return getPrenotataPeerImpl().retrieveByTypedPKs(pks, dbcon);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Prenotata> retrieveByObjectKeys(Collection<ObjectKey<?>> pks)
        throws TorqueException
    {
        return getPrenotataPeerImpl().retrieveByObjectKeys(pks);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Prenotata> retrieveByObjectKeys(Collection<ObjectKey<?>> pks, Connection con)
        throws TorqueException
    {
        return getPrenotataPeerImpl().retrieveByObjectKeys(pks, con);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Prenotata> doSelectJoinSpedizione(Criteria criteria)
        throws TorqueException
    {
        return getPrenotataPeerImpl().doSelectJoinSpedizione(criteria);
    }

    /**
     * Selects a collection of Prenotata objects pre-filled with their
     * Spedizione objects.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Prenotata> doSelectJoinSpedizione(
            Criteria criteria, Connection conn)
        throws TorqueException
    {
        return getPrenotataPeerImpl().doSelectJoinSpedizione(criteria, conn);
    }
    ...
    public static TableMap getTableMap()
        throws TorqueException
    {
        return getPrenotataPeerImpl().getTableMap();
    }
