...
public abstract class BaseRicevutaPeer
{
    ...
    private static RicevutaPeerImpl ricevutaPeerImpl;
    ...
    static
    {
        DatabaseMap dbMap = Torque.getOrCreateDatabase("opcal")
                .getDatabaseMap();
        if (dbMap.getTable("ricevuta") == null)
        {
            dbMap.addTable("ricevuta");
        }
        DATABASE_NAME = "opcal";
        TABLE_NAME = "ricevuta";

        TABLE = dbMap.getTable("ricevuta");
        TABLE.setJavaName("Ricevuta");
        TABLE.setOMClass(com.opcal.Ricevuta.class);
        TABLE.setPeerClass(com.opcal.RicevutaPeer.class);
        TABLE.setPrimaryKeyMethod(IDMethod.NATIVE);
        TABLE.setPrimaryKeyMethodInfo(IDMethod.ID_BROKER, TABLE.getName());
        TABLE.setPrimaryKeyMethodInfo(IDMethod.SEQUENCE, "ricevuta_SEQ");
        TABLE.setPrimaryKeyMethodInfo(IDMethod.AUTO_INCREMENT, "ricevuta");
    ...
    // ------------- Column: codice --------------------
        ...
        CODICE.setDescription("Codice della spedizione a cui la ricevuta si riferisce");
        CODICE.setSize(255);
    ...
    // ------------- Column: stato --------------------
        ...
        STATO.setDescription("Stato del pagamento");
        STATO.setSize(64);
        STATO.setPosition(2);
    ...
    // ------------- Column: data --------------------
        ...
        DATA.setDescription("Data del pagamento");
        DATA.setSize(255);
        DATA.setPosition(3);
    ...
    // ------------- Column: email_cliente --------------------
        ...
        EMAIL_CLIENTE.setDescription("Cliente a cui la ricevuta è a carico");
        EMAIL_CLIENTE.setSize(255);
        EMAIL_CLIENTE.setPosition(4);
     ...
     */
    protected static RicevutaPeerImpl createRicevutaPeerImpl()
    {
        RicevutaPeerImpl instance = new RicevutaPeerImpl();
        return instance;
    }
     ...
     */
    public static RicevutaPeerImpl getRicevutaPeerImpl()
    {
        RicevutaPeerImpl peerImplInstance = ricevutaPeerImpl;
        if (peerImplInstance == null)
        {
            peerImplInstance = RicevutaPeer.createRicevutaPeerImpl();
            ricevutaPeerImpl = peerImplInstance;
            Torque.registerPeerInstance(Ricevuta.class, peerImplInstance);
        }
     ...
     */
    public static void setRicevutaPeerImpl(RicevutaPeerImpl peerImplInstance)
    {
        ricevutaPeerImpl = peerImplInstance;
    }
    ...
    {
        getRicevutaPeerImpl().addSelectColumns(criteria);
    }
    ...
    {
        getRicevutaPeerImpl().correctBooleans(criteria);
    }
    ...
    {
        getRicevutaPeerImpl().correctBooleans(columnValues);
    }
    
    /**
     * Selects Ricevuta objects from a database.
     *
     ...
     */
    public static List<Ricevuta> doSelect(Criteria criteria)
            throws TorqueException
    {
        return getRicevutaPeerImpl().doSelect(criteria);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Ricevuta> doSelect(
                Criteria criteria,
                Connection connection)
            throws TorqueException
    {
        return getRicevutaPeerImpl().doSelect(criteria, connection);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static Stream<Ricevuta> doSelectAsStream(
                Criteria criteria,
                Connection connection)
            throws TorqueException
    {
        return getRicevutaPeerImpl().doSelectAsStream(criteria, connection);
    }
    ...
    public static <T> List<T> doSelect(
            ...
            throws TorqueException
    {
        return getRicevutaPeerImpl().doSelect(criteria, mapper);
    }
    ...
    public static <T> List<T> doSelect(
        ...
        throws TorqueException
    {
        return getRicevutaPeerImpl().doSelect(
                criteria,
                mapper,
                connection);
    }
    ...
    public static <T> Stream<T> doSelectAsStream(
        ...
        throws TorqueException
    {
        return getRicevutaPeerImpl().doSelectAsStream(
                criteria,
                mapper,
                connection);
    }
    ...
    /**
     * Selects Ricevuta objects from the database which have
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Ricevuta> doSelect(Ricevuta obj)
            throws TorqueException
    {
        return getRicevutaPeerImpl().doSelect(obj);
    }

    /**
     * Selects at most one Ricevuta object from a database.
     *
     * @param criteria object used to create the SELECT statement.
     *
     ...
     */
    public static Ricevuta doSelectSingleRecord(
                Criteria criteria)
            throws TorqueException
    {
        return getRicevutaPeerImpl().doSelectSingleRecord(criteria);
    }
    ...
    public static Ricevuta doSelectSingleRecord(
            ...
            throws TorqueException
    {
        return getRicevutaPeerImpl().doSelectSingleRecord(criteria, connection);
    }
    ...
    public static <T> T doSelectSingleRecord(
            ...
            throws TorqueException
    {
        return getRicevutaPeerImpl().doSelectSingleRecord(
                criteria,
                mapper);
    }
    ...
    /**
     * Selects at most one Ricevuta object from the database
    ...
    public static Ricevuta doSelectSingleRecord(
            ...
            throws TorqueException
    {
        return getRicevutaPeerImpl().doSelectSingleRecord(obj);
    }
     ...
     */
    public static Ricevuta getDbObjectInstance()
    {
        return getRicevutaPeerImpl().getDbObjectInstance();
    }
    ...
    public static ObjectKey<?> doInsert(ColumnValues columnValues) 
            throws TorqueException
    {
        return getRicevutaPeerImpl().doInsert(columnValues);
    }
    ...
    public static ObjectKey<?> doInsert(ColumnValues columnValues, Connection con)
            throws TorqueException
    {
        return getRicevutaPeerImpl().doInsert(columnValues, con);
    }
    /**
     * Method to do inserts
     *
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(Ricevuta obj)
            throws TorqueException
    {
        getRicevutaPeerImpl().doInsert(obj);
    }

    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(Ricevuta) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(Ricevuta obj, Connection con)
            throws TorqueException
    {
        getRicevutaPeerImpl().doInsert(obj, con);
    }
    ...
    public static int doInsert(
            ...
            throws TorqueException
    {
        return getRicevutaPeerImpl().doInsert(toInsertInto, criteria);
    }
    ...
    public static int doInsert(
            ...
            throws TorqueException
    {
        return getRicevutaPeerImpl().doInsert(toInsertInto, criteria, dbName);
    }
    ...
    public static int doInsert(
            ...
            throws TorqueException
    {
        return getRicevutaPeerImpl().doInsert(toInsertInto, criteria, connection);
    }
    ...
    public static int doInsert(
            ...
            throws TorqueException
    {
        return getRicevutaPeerImpl().doInsert(
                 toInsertInto,
                 criteria,
                 dbName,
                 connection);
    ...
    {
        return getRicevutaPeerImpl().doUpdate(columnValues);
    }
    ...
    public static int doUpdate(ColumnValues columnValues, Connection con)
        throws TorqueException
    {
        return getRicevutaPeerImpl().doUpdate(columnValues, con);
    }
    ...
    public static int doUpdate(
            ...
            throws TorqueException
    {
        return getRicevutaPeerImpl().doUpdate(
            selectCriteria,
            updateValues);
    }
    ...
    /**
     * Updates an Ricevuta in the database.
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static int doUpdate(Ricevuta obj) throws TorqueException
    {
        return getRicevutaPeerImpl().doUpdate(obj);
    }

    /**
     * Updates a Ricevuta in the database.
     * The primary key is used to identify the object to update.
     * This method is to be used during a transaction,
     * otherwise the doUpdate(Ricevuta) method can be used.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use, not null.
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static int doUpdate(Ricevuta obj, Connection con)
        throws TorqueException
    {
        return getRicevutaPeerImpl().doUpdate(obj, con);
    }
    ...
    public static int executeStatement(String statementString) 
            throws TorqueException
    {
        return getRicevutaPeerImpl().executeStatement(statementString);
    }
    ...
    public static int executeStatement(
            ...
            throws TorqueException
    {
        return getRicevutaPeerImpl().executeStatement(
                statementString, 
                replacementValues);
    }
     ...
     */
     ...
     {
        return getRicevutaPeerImpl().doDelete(criteria);
     }
    ...
    *
     ...
     */
     public static int doDelete(Criteria criteria, Connection con)
        throws TorqueException
     {
        return getRicevutaPeerImpl().doDelete(criteria, con);
     }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static int doDelete(Ricevuta obj) throws TorqueException
    {
        return getRicevutaPeerImpl().doDelete(obj);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static int doDelete(Ricevuta obj, Connection con)
        throws TorqueException
    {
        return getRicevutaPeerImpl().doDelete(obj, con);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static int doDelete(Collection<Ricevuta> objects)
            throws TorqueException
    {
        return getRicevutaPeerImpl().doDelete(objects);
    }
    ...
    public static int doDelete(
        ...
        throws TorqueException
    {
        return getRicevutaPeerImpl().doDelete(objects, con);
    }
    ...
    {
        return getRicevutaPeerImpl().doDelete(pk);
    }
    ...
    public static int doDelete(ObjectKey<?> pk, Connection con)
        throws TorqueException
    {
        return getRicevutaPeerImpl().doDelete(pk, con);
    }
    ...
    {
        return getRicevutaPeerImpl().buildCriteria(pk);
    }
    ...
    {
        return getRicevutaPeerImpl().buildCriteria(pks);
    }
    ...
    public static Criteria buildPkCriteria(
            Collection<Ricevuta> objects)
    {
        return getRicevutaPeerImpl().buildPkCriteria(objects);
    }
     ...
     */
    public static Criteria buildCriteria(Ricevuta obj)
    {
        return getRicevutaPeerImpl().buildCriteria(obj);
    }
     ...
     * @param obj the object to build the criteria from, not null.
     */
    public static Criteria buildSelectCriteria(Ricevuta obj)
    {
        return getRicevutaPeerImpl().buildSelectCriteria(obj);
    }
     ...
     *         (should not happen).
     */
    public static ColumnValues buildColumnValues(Ricevuta ricevuta)
            throws TorqueException
    {
        
        return getRicevutaPeerImpl().buildColumnValues(ricevuta);
    }
     ...
     */
    public static Ricevuta retrieveByPK(String pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        return getRicevutaPeerImpl().retrieveByPK(pk);
    }
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static Ricevuta retrieveByPK(String pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        return getRicevutaPeerImpl().retrieveByPK(pk, con);
    }
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static Ricevuta retrieveByPK(ObjectKey<?> pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        return getRicevutaPeerImpl().retrieveByPK(pk);
    }
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static Ricevuta retrieveByPK(ObjectKey<?> pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        return getRicevutaPeerImpl().retrieveByPK(pk, con);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Ricevuta> retrieveByTypedPKs(Collection<String> pks)
        throws TorqueException
    {
        return getRicevutaPeerImpl().retrieveByTypedPKs(pks);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Ricevuta> retrieveByTypedPKs(
                Collection<String> pks,
                Connection dbcon)
            throws TorqueException
    {
        return getRicevutaPeerImpl().retrieveByTypedPKs(pks, dbcon);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Ricevuta> retrieveByObjectKeys(Collection<ObjectKey<?>> pks)
        throws TorqueException
    {
        return getRicevutaPeerImpl().retrieveByObjectKeys(pks);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Ricevuta> retrieveByObjectKeys(Collection<ObjectKey<?>> pks, Connection con)
        throws TorqueException
    {
        return getRicevutaPeerImpl().retrieveByObjectKeys(pks, con);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Ricevuta> doSelectJoinCliente(Criteria criteria)
        throws TorqueException
    {
        return getRicevutaPeerImpl().doSelectJoinCliente(criteria);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Ricevuta> doSelectJoinCliente(
            Criteria criteria, Connection conn)
        throws TorqueException
    {
        return getRicevutaPeerImpl().doSelectJoinCliente(criteria, conn);
    }
    /**
     * Selects a collection of dbObjectClassName objects pre-filled with their
     * Spedizione objects.
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Ricevuta> doSelectJoinSpedizione(Criteria criteria)
        throws TorqueException
    {
        return getRicevutaPeerImpl().doSelectJoinSpedizione(criteria);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Ricevuta> doSelectJoinSpedizione(
            Criteria criteria, Connection conn)
        throws TorqueException
    {
        return getRicevutaPeerImpl().doSelectJoinSpedizione(criteria, conn);
    }
    ...
    public static TableMap getTableMap()
        throws TorqueException
    {
        return getRicevutaPeerImpl().getTableMap();
    }
