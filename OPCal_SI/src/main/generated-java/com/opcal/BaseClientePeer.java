...
public abstract class BaseClientePeer
{
    ...
    private static ClientePeerImpl clientePeerImpl;
    ...
    static
    {
        DatabaseMap dbMap = Torque.getOrCreateDatabase("opcal")
                .getDatabaseMap();
        if (dbMap.getTable("cliente") == null)
        {
            dbMap.addTable("cliente");
        }
        DATABASE_NAME = "opcal";
        TABLE_NAME = "cliente";

        TABLE = dbMap.getTable("cliente");
        TABLE.setJavaName("Cliente");
        TABLE.setOMClass(com.opcal.Cliente.class);
        TABLE.setPeerClass(com.opcal.ClientePeer.class);
        TABLE.setPrimaryKeyMethod(IDMethod.NATIVE);
        TABLE.setPrimaryKeyMethodInfo(IDMethod.ID_BROKER, TABLE.getName());
        TABLE.setPrimaryKeyMethodInfo(IDMethod.SEQUENCE, "cliente_SEQ");
        TABLE.setPrimaryKeyMethodInfo(IDMethod.AUTO_INCREMENT, "cliente");
    ...
    // ------------- Column: email --------------------
        ...
        EMAIL.setDescription("Email cliente");
        EMAIL.setSize(255);
        EMAIL.setPosition(1);
     ...
     */
    protected static ClientePeerImpl createClientePeerImpl()
    {
        ClientePeerImpl instance = new ClientePeerImpl();
        return instance;
    }
     ...
     */
    public static ClientePeerImpl getClientePeerImpl()
    {
        ClientePeerImpl peerImplInstance = clientePeerImpl;
        if (peerImplInstance == null)
        {
            peerImplInstance = ClientePeer.createClientePeerImpl();
            clientePeerImpl = peerImplInstance;
            Torque.registerPeerInstance(Cliente.class, peerImplInstance);
        }
     ...
     */
    public static void setClientePeerImpl(ClientePeerImpl peerImplInstance)
    {
        clientePeerImpl = peerImplInstance;
    }
    ...
    {
        getClientePeerImpl().addSelectColumns(criteria);
    }
    ...
    {
        getClientePeerImpl().correctBooleans(criteria);
    }
    ...
    {
        getClientePeerImpl().correctBooleans(columnValues);
    }
    
    /**
     * Selects Cliente objects from a database.
     *
     ...
     */
    public static List<Cliente> doSelect(Criteria criteria)
            throws TorqueException
    {
        return getClientePeerImpl().doSelect(criteria);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Cliente> doSelect(
                Criteria criteria,
                Connection connection)
            throws TorqueException
    {
        return getClientePeerImpl().doSelect(criteria, connection);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static Stream<Cliente> doSelectAsStream(
                Criteria criteria,
                Connection connection)
            throws TorqueException
    {
        return getClientePeerImpl().doSelectAsStream(criteria, connection);
    }
    ...
    public static <T> List<T> doSelect(
            ...
            throws TorqueException
    {
        return getClientePeerImpl().doSelect(criteria, mapper);
    }
    ...
    public static <T> List<T> doSelect(
        ...
        throws TorqueException
    {
        return getClientePeerImpl().doSelect(
                criteria,
                mapper,
                connection);
    }
    ...
    public static <T> Stream<T> doSelectAsStream(
        ...
        throws TorqueException
    {
        return getClientePeerImpl().doSelectAsStream(
                criteria,
                mapper,
                connection);
    }
    ...
    /**
     * Selects Cliente objects from the database which have
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Cliente> doSelect(Cliente obj)
            throws TorqueException
    {
        return getClientePeerImpl().doSelect(obj);
    }

    /**
     * Selects at most one Cliente object from a database.
     *
     * @param criteria object used to create the SELECT statement.
     *
     ...
     */
    public static Cliente doSelectSingleRecord(
                Criteria criteria)
            throws TorqueException
    {
        return getClientePeerImpl().doSelectSingleRecord(criteria);
    }
    ...
    public static Cliente doSelectSingleRecord(
            ...
            throws TorqueException
    {
        return getClientePeerImpl().doSelectSingleRecord(criteria, connection);
    }
    ...
    public static <T> T doSelectSingleRecord(
            ...
            throws TorqueException
    {
        return getClientePeerImpl().doSelectSingleRecord(
                criteria,
                mapper);
    }
    ...
    /**
     * Selects at most one Cliente object from the database
    ...
    public static Cliente doSelectSingleRecord(
            ...
            throws TorqueException
    {
        return getClientePeerImpl().doSelectSingleRecord(obj);
    }
     ...
     */
    public static Cliente getDbObjectInstance()
    {
        return getClientePeerImpl().getDbObjectInstance();
    }
    ...
    public static ObjectKey<?> doInsert(ColumnValues columnValues) 
            throws TorqueException
    {
        return getClientePeerImpl().doInsert(columnValues);
    }
    ...
    public static ObjectKey<?> doInsert(ColumnValues columnValues, Connection con)
            throws TorqueException
    {
        return getClientePeerImpl().doInsert(columnValues, con);
    }
    /**
     * Method to do inserts
     *
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(Cliente obj)
            throws TorqueException
    {
        getClientePeerImpl().doInsert(obj);
    }

    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(Cliente) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(Cliente obj, Connection con)
            throws TorqueException
    {
        getClientePeerImpl().doInsert(obj, con);
    }
    ...
    public static int doInsert(
            ...
            throws TorqueException
    {
        return getClientePeerImpl().doInsert(toInsertInto, criteria);
    }
    ...
    public static int doInsert(
            ...
            throws TorqueException
    {
        return getClientePeerImpl().doInsert(toInsertInto, criteria, dbName);
    }
    ...
    public static int doInsert(
            ...
            throws TorqueException
    {
        return getClientePeerImpl().doInsert(toInsertInto, criteria, connection);
    }
    ...
    public static int doInsert(
            ...
            throws TorqueException
    {
        return getClientePeerImpl().doInsert(
                 toInsertInto,
                 criteria,
                 dbName,
                 connection);
    ...
    {
        return getClientePeerImpl().doUpdate(columnValues);
    }
    ...
    public static int doUpdate(ColumnValues columnValues, Connection con)
        throws TorqueException
    {
        return getClientePeerImpl().doUpdate(columnValues, con);
    }
    ...
    public static int doUpdate(
            ...
            throws TorqueException
    {
        return getClientePeerImpl().doUpdate(
            selectCriteria,
            updateValues);
    }
    ...
    /**
     * Updates an Cliente in the database.
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static int doUpdate(Cliente obj) throws TorqueException
    {
        return getClientePeerImpl().doUpdate(obj);
    }

    /**
     * Updates a Cliente in the database.
     * The primary key is used to identify the object to update.
     * This method is to be used during a transaction,
     * otherwise the doUpdate(Cliente) method can be used.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use, not null.
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static int doUpdate(Cliente obj, Connection con)
        throws TorqueException
    {
        return getClientePeerImpl().doUpdate(obj, con);
    }
    ...
    public static int executeStatement(String statementString) 
            throws TorqueException
    {
        return getClientePeerImpl().executeStatement(statementString);
    }
    ...
    public static int executeStatement(
            ...
            throws TorqueException
    {
        return getClientePeerImpl().executeStatement(
                statementString, 
                replacementValues);
    }
     ...
     */
     ...
     {
        return getClientePeerImpl().doDelete(criteria);
     }
    ...
    *
     ...
     */
     public static int doDelete(Criteria criteria, Connection con)
        throws TorqueException
     {
        return getClientePeerImpl().doDelete(criteria, con);
     }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static int doDelete(Cliente obj) throws TorqueException
    {
        return getClientePeerImpl().doDelete(obj);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static int doDelete(Cliente obj, Connection con)
        throws TorqueException
    {
        return getClientePeerImpl().doDelete(obj, con);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static int doDelete(Collection<Cliente> objects)
            throws TorqueException
    {
        return getClientePeerImpl().doDelete(objects);
    }
    ...
    public static int doDelete(
        ...
        throws TorqueException
    {
        return getClientePeerImpl().doDelete(objects, con);
    }
    ...
    {
        return getClientePeerImpl().doDelete(pk);
    }
    ...
    public static int doDelete(ObjectKey<?> pk, Connection con)
        throws TorqueException
    {
        return getClientePeerImpl().doDelete(pk, con);
    }
    ...
    {
        return getClientePeerImpl().buildCriteria(pk);
    }
    ...
    {
        return getClientePeerImpl().buildCriteria(pks);
    }
    ...
    public static Criteria buildPkCriteria(
            Collection<Cliente> objects)
    {
        return getClientePeerImpl().buildPkCriteria(objects);
    }
     ...
     */
    public static Criteria buildCriteria(Cliente obj)
    {
        return getClientePeerImpl().buildCriteria(obj);
    }
     ...
     * @param obj the object to build the criteria from, not null.
     */
    public static Criteria buildSelectCriteria(Cliente obj)
    {
        return getClientePeerImpl().buildSelectCriteria(obj);
    }
     ...
     *         (should not happen).
     */
    public static ColumnValues buildColumnValues(Cliente cliente)
            throws TorqueException
    {
        
        return getClientePeerImpl().buildColumnValues(cliente);
    }
     ...
     */
    public static Cliente retrieveByPK(String pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        return getClientePeerImpl().retrieveByPK(pk);
    }
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static Cliente retrieveByPK(String pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        return getClientePeerImpl().retrieveByPK(pk, con);
    }
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static Cliente retrieveByPK(ObjectKey<?> pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        return getClientePeerImpl().retrieveByPK(pk);
    }
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static Cliente retrieveByPK(ObjectKey<?> pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        return getClientePeerImpl().retrieveByPK(pk, con);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Cliente> retrieveByTypedPKs(Collection<String> pks)
        throws TorqueException
    {
        return getClientePeerImpl().retrieveByTypedPKs(pks);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Cliente> retrieveByTypedPKs(
                Collection<String> pks,
                Connection dbcon)
            throws TorqueException
    {
        return getClientePeerImpl().retrieveByTypedPKs(pks, dbcon);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Cliente> retrieveByObjectKeys(Collection<ObjectKey<?>> pks)
        throws TorqueException
    {
        return getClientePeerImpl().retrieveByObjectKeys(pks);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Cliente> retrieveByObjectKeys(Collection<ObjectKey<?>> pks, Connection con)
        throws TorqueException
    {
        return getClientePeerImpl().retrieveByObjectKeys(pks, con);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Cliente> doSelectJoinUtente(Criteria criteria)
        throws TorqueException
    {
        return getClientePeerImpl().doSelectJoinUtente(criteria);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Cliente> doSelectJoinUtente(
            Criteria criteria, Connection conn)
        throws TorqueException
    {
        return getClientePeerImpl().doSelectJoinUtente(criteria, conn);
    }
     ...
     */
    public static void setAndSaveIndirizzos(
            Cliente toLinkTo,
            Collection<Indirizzo> toSave) 
        throws TorqueException
    {
        getClientePeerImpl().setAndSaveIndirizzos(toLinkTo, toSave);
    }
    ...
    public static void setAndSaveRicevutas(
        ...
        throws TorqueException
    {
        getClientePeerImpl().setAndSaveRicevutas(toLinkTo, toSave);
    }
     ...
     * @throws NullPointerException if toSave is null or contains null elements.
     */
    public static void setAndSaveSpedizioneRelatedByEmailMittentes(
            Cliente toLinkTo,
            Collection<Spedizione> toSave) 
        throws TorqueException
    {
        getClientePeerImpl().setAndSaveSpedizioneRelatedByEmailMittentes(toLinkTo, toSave);
    }
     ...
     * @throws NullPointerException if toSave is null or contains null elements.
     */
    public static void setAndSaveSpedizioneRelatedByEmailDestinatarios(
            Cliente toLinkTo,
            Collection<Spedizione> toSave) 
        throws TorqueException
    {
        getClientePeerImpl().setAndSaveSpedizioneRelatedByEmailDestinatarios(toLinkTo, toSave);
    }
    ...
    public static TableMap getTableMap()
        throws TorqueException
    {
        return getClientePeerImpl().getTableMap();
    }
