...
public abstract class BasePrenotataPeerImpl
    extends org.apache.torque.util.AbstractPeerImpl<Prenotata>
{
    /** Serial version */
    private static final long serialVersionUID = 1741873522890L;
     ...
     * initialized.
     */
    public BasePrenotataPeerImpl()
    {
        this(new PrenotataRecordMapper(),
            PrenotataPeer.TABLE,
            PrenotataPeer.DATABASE_NAME);
    }
     ...
     */
    public BasePrenotataPeerImpl(
            RecordMapper<Prenotata> recordMapper, 
            TableMap tableMap,
            String databaseName)
    {
     ...
     */
    public Prenotata getDbObjectInstance()
    {
        return new Prenotata();
    }
        ...
        throws TorqueException
    {
...

        {
            JdbcTypedValue pkValue
                = columnValues.remove(PrenotataPeer.CODICE);
            if (pkValue == null)
            {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public int doDelete(Prenotata obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public int doDelete(Prenotata obj, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public int doDelete(Collection<Prenotata> objects)
            throws TorqueException
    {
    ...
    public Criteria buildCriteria(ObjectKey<?> pk)
    {
        ...
        criteria.and(PrenotataPeer.CODICE, pk);
        return criteria;
     }
    ...
    {
        Criteria criteria = new Criteria();
        criteria.andIn(PrenotataPeer.CODICE, pks);
        return criteria;
     }
     ...
     */
    public Criteria buildCriteria(Prenotata obj)
    {
        Criteria criteria = new Criteria(getDatabaseName());
        if (!obj.isNew())
        {
            criteria.and(PrenotataPeer.CODICE, obj.getCodice());
        }
        criteria.and(PrenotataPeer.DATA_RITIRO, obj.getDataRitiro());
        criteria.and(PrenotataPeer.DATA_PRENOTAZIONE, obj.getDataPrenotazione());
        return criteria;
    }
     ...
     * @param obj the object to build the criteria from, not null.
     */
    public Criteria buildSelectCriteria(Prenotata obj)
    {
        Criteria criteria = new Criteria(getDatabaseName());
        if (!obj.isNew())
        {
     ...
     *         (should not happen).
     */
    public ColumnValues buildColumnValues(Prenotata prenotata)
            throws TorqueException
    {
        ColumnValues columnValues = new ColumnValues();
        if (!prenotata.isNew() 
            || prenotata.getCodice() != null)
        {
            columnValues.put(
                    PrenotataPeer.CODICE,
                    new JdbcTypedValue(
        ...
        java.util.Date dataRitiro = prenotata.getDataRitiro();
        if (dataRitiro != null)
        {
            dataRitiro = new java.sql.Date(dataRitiro.getTime());
        }
        columnValues.put(
                PrenotataPeer.DATA_RITIRO,
                new JdbcTypedValue(dataRitiro, Types.DATE));
        java.util.Date dataPrenotazione = prenotata.getDataPrenotazione();
        if (dataPrenotazione != null)
        {
            dataPrenotazione = new java.sql.Date(dataPrenotazione.getTime());
        }
        columnValues.put(
                PrenotataPeer.DATA_PRENOTAZIONE,
                new JdbcTypedValue(dataPrenotazione, Types.DATE));
        return columnValues;
    }
     ...
     */
    public Prenotata retrieveByPK(String pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public Prenotata retrieveByPK(String pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public Prenotata retrieveByPK(ObjectKey<?> pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        try (TorqueConnection connection = Transaction.begin(getDatabaseName()))
        {
            Prenotata result = retrieveByPK(pk, connection);
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public Prenotata retrieveByPK(ObjectKey<?> pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        Prenotata v = doSelectSingleRecord(criteria, con);
        if (v == null)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public List<Prenotata> retrieveByTypedPKs(Collection<String> pks)
        throws TorqueException
    {
        try (TorqueConnection connection = Transaction.begin(getDatabaseName()))
        {
            List<Prenotata> result = retrieveByTypedPKs(pks, connection);
            Transaction.commit(connection);
            return result;
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public List<Prenotata> retrieveByTypedPKs(
            ...
            throws TorqueException
    {
        ...
        {
            return new ArrayList<Prenotata>();
        }
        ...
        List<Prenotata> result = doSelect(criteria, dbcon);
        return result;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public List<Prenotata> retrieveByObjectKeys(Collection<ObjectKey<?>> pks)
        throws TorqueException
    {
        try (TorqueConnection connection = Transaction.begin(getDatabaseName()))
        {
            List<Prenotata> result = retrieveByObjectKeys(pks, connection);
            Transaction.commit(connection);
            return result;
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public List<Prenotata> retrieveByObjectKeys(
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public List<Prenotata> doSelectJoinSpedizione(Criteria criteria)
        throws TorqueException
    {
        try (TorqueConnection connection = Transaction.begin(getDatabaseName()))
        {
            List<Prenotata> result
                    = PrenotataPeer.doSelectJoinSpedizione(criteria, connection);
            Transaction.commit(connection);
            return result;
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public List<Prenotata> doSelectJoinSpedizione(
