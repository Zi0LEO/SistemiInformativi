...
public abstract class BaseDipendentePeer
{
    ...
    /** The column for the permessi field */
    public static final ColumnMap PERMESSI;
    ...
    private static DipendentePeerImpl dipendentePeerImpl;
    ...
    static
    {
        DatabaseMap dbMap = Torque.getOrCreateDatabase("opcal")
                .getDatabaseMap();
        if (dbMap.getTable("dipendente") == null)
        {
            dbMap.addTable("dipendente");
        }
        DATABASE_NAME = "opcal";
        TABLE_NAME = "dipendente";

        TABLE = dbMap.getTable("dipendente");
        TABLE.setJavaName("Dipendente");
        TABLE.setOMClass(com.opcal.Dipendente.class);
        TABLE.setPeerClass(com.opcal.DipendentePeer.class);
        TABLE.setPrimaryKeyMethod(IDMethod.NATIVE);
        TABLE.setPrimaryKeyMethodInfo(IDMethod.ID_BROKER, TABLE.getName());
        TABLE.setPrimaryKeyMethodInfo(IDMethod.SEQUENCE, "dipendente_SEQ");
        TABLE.setPrimaryKeyMethodInfo(IDMethod.AUTO_INCREMENT, "dipendente");
    ...
    // ------------- Column: email --------------------
        ...
        EMAIL.setDescription("email dipendente");
        EMAIL.setSize(255);
        EMAIL.setPosition(1);
        TABLE.addColumn(EMAIL);
    // ------------- Column: permessi --------------------
        PERMESSI = new ColumnMap("permessi", TABLE);
        PERMESSI.setType(Integer.valueOf(0));
        PERMESSI.setTorqueType("INTEGER");
        PERMESSI.setUsePrimitive(true);
        PERMESSI.setPrimaryKey(false);
        PERMESSI.setNotNull(true);
        PERMESSI.setJavaName("Permessi");
        PERMESSI.setAutoIncrement(true);
        PERMESSI.setProtected(false);
        PERMESSI.setJavaType( "int" );
        PERMESSI.setDescription("permessi del dipendente");
        PERMESSI.setSize(84);
        PERMESSI.setPosition(2);
        TABLE.addColumn(PERMESSI);
     ...
     */
    protected static DipendentePeerImpl createDipendentePeerImpl()
    {
        DipendentePeerImpl instance = new DipendentePeerImpl();
        return instance;
    }
     ...
     */
    public static DipendentePeerImpl getDipendentePeerImpl()
    {
        DipendentePeerImpl peerImplInstance = dipendentePeerImpl;
        if (peerImplInstance == null)
        {
            peerImplInstance = DipendentePeer.createDipendentePeerImpl();
            dipendentePeerImpl = peerImplInstance;
            Torque.registerPeerInstance(Dipendente.class, peerImplInstance);
        }
     ...
     */
    public static void setDipendentePeerImpl(DipendentePeerImpl peerImplInstance)
    {
        dipendentePeerImpl = peerImplInstance;
    }
    ...
    {
        getDipendentePeerImpl().addSelectColumns(criteria);
    }
    ...
    {
        getDipendentePeerImpl().correctBooleans(criteria);
    }
    ...
    {
        getDipendentePeerImpl().correctBooleans(columnValues);
    }
    
    /**
     * Selects Dipendente objects from a database.
     *
     ...
     */
    public static List<Dipendente> doSelect(Criteria criteria)
            throws TorqueException
    {
        return getDipendentePeerImpl().doSelect(criteria);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Dipendente> doSelect(
                Criteria criteria,
                Connection connection)
            throws TorqueException
    {
        return getDipendentePeerImpl().doSelect(criteria, connection);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static Stream<Dipendente> doSelectAsStream(
                Criteria criteria,
                Connection connection)
            throws TorqueException
    {
        return getDipendentePeerImpl().doSelectAsStream(criteria, connection);
    }
    ...
    public static <T> List<T> doSelect(
            ...
            throws TorqueException
    {
        return getDipendentePeerImpl().doSelect(criteria, mapper);
    }
    ...
    public static <T> List<T> doSelect(
        ...
        throws TorqueException
    {
        return getDipendentePeerImpl().doSelect(
                criteria,
                mapper,
                connection);
    }
    ...
    public static <T> Stream<T> doSelectAsStream(
        ...
        throws TorqueException
    {
        return getDipendentePeerImpl().doSelectAsStream(
                criteria,
                mapper,
                connection);
    }
    ...
    /**
     * Selects Dipendente objects from the database which have
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Dipendente> doSelect(Dipendente obj)
            throws TorqueException
    {
        return getDipendentePeerImpl().doSelect(obj);
    }

    /**
     * Selects at most one Dipendente object from a database.
     *
     * @param criteria object used to create the SELECT statement.
     *
     ...
     */
    public static Dipendente doSelectSingleRecord(
                Criteria criteria)
            throws TorqueException
    {
        return getDipendentePeerImpl().doSelectSingleRecord(criteria);
    }
    ...
    public static Dipendente doSelectSingleRecord(
            ...
            throws TorqueException
    {
        return getDipendentePeerImpl().doSelectSingleRecord(criteria, connection);
    }
    ...
    public static <T> T doSelectSingleRecord(
            ...
            throws TorqueException
    {
        return getDipendentePeerImpl().doSelectSingleRecord(
                criteria,
                mapper);
    }
    ...
    /**
     * Selects at most one Dipendente object from the database
    ...
    public static Dipendente doSelectSingleRecord(
            ...
            throws TorqueException
    {
        return getDipendentePeerImpl().doSelectSingleRecord(obj);
    }
     ...
     */
    public static Dipendente getDbObjectInstance()
    {
        return getDipendentePeerImpl().getDbObjectInstance();
    }
    ...
    public static ObjectKey<?> doInsert(ColumnValues columnValues) 
            throws TorqueException
    {
        return getDipendentePeerImpl().doInsert(columnValues);
    }
    ...
    public static ObjectKey<?> doInsert(ColumnValues columnValues, Connection con)
            throws TorqueException
    {
        return getDipendentePeerImpl().doInsert(columnValues, con);
    }
    /**
     * Method to do inserts
     *
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(Dipendente obj)
            throws TorqueException
    {
        getDipendentePeerImpl().doInsert(obj);
    }

    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(Dipendente) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(Dipendente obj, Connection con)
            throws TorqueException
    {
        getDipendentePeerImpl().doInsert(obj, con);
    }
    ...
    public static int doInsert(
            ...
            throws TorqueException
    {
        return getDipendentePeerImpl().doInsert(toInsertInto, criteria);
    }
    ...
    public static int doInsert(
            ...
            throws TorqueException
    {
        return getDipendentePeerImpl().doInsert(toInsertInto, criteria, dbName);
    }
    ...
    public static int doInsert(
            ...
            throws TorqueException
    {
        return getDipendentePeerImpl().doInsert(toInsertInto, criteria, connection);
    }
    ...
    public static int doInsert(
            ...
            throws TorqueException
    {
        return getDipendentePeerImpl().doInsert(
                 toInsertInto,
                 criteria,
                 dbName,
                 connection);
    ...
    {
        return getDipendentePeerImpl().doUpdate(columnValues);
    }
    ...
    public static int doUpdate(ColumnValues columnValues, Connection con)
        throws TorqueException
    {
        return getDipendentePeerImpl().doUpdate(columnValues, con);
    }
    ...
    public static int doUpdate(
            ...
            throws TorqueException
    {
        return getDipendentePeerImpl().doUpdate(
            selectCriteria,
            updateValues);
    }
    ...
    /**
     * Updates an Dipendente in the database.
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static int doUpdate(Dipendente obj) throws TorqueException
    {
        return getDipendentePeerImpl().doUpdate(obj);
    }

    /**
     * Updates a Dipendente in the database.
     * The primary key is used to identify the object to update.
     * This method is to be used during a transaction,
     * otherwise the doUpdate(Dipendente) method can be used.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use, not null.
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static int doUpdate(Dipendente obj, Connection con)
        throws TorqueException
    {
        return getDipendentePeerImpl().doUpdate(obj, con);
    }
    ...
    public static int executeStatement(String statementString) 
            throws TorqueException
    {
        return getDipendentePeerImpl().executeStatement(statementString);
    }
    ...
    public static int executeStatement(
            ...
            throws TorqueException
    {
        return getDipendentePeerImpl().executeStatement(
                statementString, 
                replacementValues);
    }
     ...
     */
     ...
     {
        return getDipendentePeerImpl().doDelete(criteria);
     }
    ...
    *
     ...
     */
     public static int doDelete(Criteria criteria, Connection con)
        throws TorqueException
     {
        return getDipendentePeerImpl().doDelete(criteria, con);
     }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static int doDelete(Dipendente obj) throws TorqueException
    {
        return getDipendentePeerImpl().doDelete(obj);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static int doDelete(Dipendente obj, Connection con)
        throws TorqueException
    {
        return getDipendentePeerImpl().doDelete(obj, con);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static int doDelete(Collection<Dipendente> objects)
            throws TorqueException
    {
        return getDipendentePeerImpl().doDelete(objects);
    }
    ...
    public static int doDelete(
        ...
        throws TorqueException
    {
        return getDipendentePeerImpl().doDelete(objects, con);
    }
    ...
    {
        return getDipendentePeerImpl().doDelete(pk);
    }
    ...
    public static int doDelete(ObjectKey<?> pk, Connection con)
        throws TorqueException
    {
        return getDipendentePeerImpl().doDelete(pk, con);
    }
    ...
    {
        return getDipendentePeerImpl().buildCriteria(pk);
    }
    ...
    {
        return getDipendentePeerImpl().buildCriteria(pks);
    }
    ...
    public static Criteria buildPkCriteria(
            Collection<Dipendente> objects)
    {
        return getDipendentePeerImpl().buildPkCriteria(objects);
    }
     ...
     */
    public static Criteria buildCriteria(Dipendente obj)
    {
        return getDipendentePeerImpl().buildCriteria(obj);
    }
     ...
     * @param obj the object to build the criteria from, not null.
     */
    public static Criteria buildSelectCriteria(Dipendente obj)
    {
        return getDipendentePeerImpl().buildSelectCriteria(obj);
    }
     ...
     *         (should not happen).
     */
    public static ColumnValues buildColumnValues(Dipendente dipendente)
            throws TorqueException
    {
        
        return getDipendentePeerImpl().buildColumnValues(dipendente);
    }
     ...
     */
    public static Dipendente retrieveByPK(String pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        return getDipendentePeerImpl().retrieveByPK(pk);
    }
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static Dipendente retrieveByPK(String pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        return getDipendentePeerImpl().retrieveByPK(pk, con);
    }
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static Dipendente retrieveByPK(ObjectKey<?> pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        return getDipendentePeerImpl().retrieveByPK(pk);
    }
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static Dipendente retrieveByPK(ObjectKey<?> pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        return getDipendentePeerImpl().retrieveByPK(pk, con);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Dipendente> retrieveByTypedPKs(Collection<String> pks)
        throws TorqueException
    {
        return getDipendentePeerImpl().retrieveByTypedPKs(pks);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Dipendente> retrieveByTypedPKs(
                Collection<String> pks,
                Connection dbcon)
            throws TorqueException
    {
        return getDipendentePeerImpl().retrieveByTypedPKs(pks, dbcon);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Dipendente> retrieveByObjectKeys(Collection<ObjectKey<?>> pks)
        throws TorqueException
    {
        return getDipendentePeerImpl().retrieveByObjectKeys(pks);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Dipendente> retrieveByObjectKeys(Collection<ObjectKey<?>> pks, Connection con)
        throws TorqueException
    {
        return getDipendentePeerImpl().retrieveByObjectKeys(pks, con);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Dipendente> doSelectJoinUtente(Criteria criteria)
        throws TorqueException
    {
        return getDipendentePeerImpl().doSelectJoinUtente(criteria);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Dipendente> doSelectJoinUtente(
            Criteria criteria, Connection conn)
        throws TorqueException
    {
        return getDipendentePeerImpl().doSelectJoinUtente(criteria, conn);
    }
    ...
    public static TableMap getTableMap()
        throws TorqueException
    {
        return getDipendentePeerImpl().getTableMap();
    }
