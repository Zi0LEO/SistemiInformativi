 ...
 * extended; all references should be to Dipendente
 */
@SuppressWarnings("unused")
public abstract class BaseDipendente 
    implements Persistent, Serializable, ColumnAccessByName
{
    /** Serial version */
    private static final long serialVersionUID = 1741873521146L;
    ...
    /**
     * Get the value of permessi.
     * The field is described as follows: 
     * permessi del dipendente
     *
     * @return the value of permessi as int
     */
    ...
    /**
     * Set the value of permessi.
     * The field is described as follows: 
     * permessi del dipendente
     *
     * @param v new value of permessi
     */
    public void setPermessi(int v)
    {
        if (this.permessi != v)
        {
            setModified(true);
    ...
    public Object getByName(String name)
    {
        ...
        {
            return Integer.valueOf(getPermessi());
        }
        return null;
    }
        ...
        throws TorqueException, IllegalArgumentException
    {
        ...
        if (name.equals("Permessi"))
        {
            ...
            setPermessi(((Integer) value).intValue());
            return true;
        }
        return false;
    }
    ...
    {
        if (com.opcal.DipendentePeer.EMAIL.getSqlExpression().equals(name)
            || com.opcal.DipendentePeer.EMAIL.getColumnName().equals(name))
        {
            return getEmail();
        }
        if (com.opcal.DipendentePeer.PERMESSI.getSqlExpression().equals(name)
            || com.opcal.DipendentePeer.PERMESSI.getColumnName().equals(name))
        {
            return Integer.valueOf(getPermessi());
        }
        return null;
        ...
        throws TorqueException, IllegalArgumentException
    {
        ...
        if (com.opcal.DipendentePeer.PERMESSI.getSqlExpression().equals(name)
            || com.opcal.DipendentePeer.PERMESSI.getColumnName().equals(name))
        {
            return setByName("Permessi", value);
        }
        return false;
    }
    ...
    {
        save(DipendentePeer.DATABASE_NAME);
    }
            ...
            throws TorqueException
    {
        ...
        try
        {
            ...
            if (isModified())
            {
                if (isNew())
                {
                    DipendentePeer.doInsert((Dipendente) this, con);
                    setNew(false);
                }
                else
                {
                    DipendentePeer.doUpdate((Dipendente) this, con);
                }
            }
     ...
     */
    public Dipendente copy() throws TorqueException
    {
        return copy(true);
    }
     ...
     * @throws TorqueException if retrieval of the associated objects fails     
     */
    public Dipendente copy(Connection con) throws TorqueException
    {
     ...
     * @throws TorqueException if retrieval of the associated objects fails
     */
    public Dipendente copy(boolean deepcopy) throws TorqueException
    {
        Dipendente dipendente = new Dipendente();

        return copyInto(dipendente, deepcopy);
    }
     ...
     * @throws TorqueException if retrieval of the associated objects fails
     */
    public Dipendente copy(boolean deepcopy, Connection con) throws TorqueException
    {
        Dipendente dipendente = new Dipendente();

        return copyInto(dipendente, deepcopy, con);
    }
     ...
     * @throws TorqueException if retrieval of the associated objects fails
     */
    public Dipendente copyInto(Dipendente copyObj) throws TorqueException
    {
     ...
     * @throws TorqueException if retrieval of the associated objects fails
     */
    public Dipendente copyInto(Dipendente copyObj, Connection con) throws TorqueException
    {
     ...
     * @throws TorqueException if retrieval of the associated objects fails
     */
    protected Dipendente copyInto(Dipendente copyObj, boolean deepcopy) throws TorqueException
    {
        copyObj.setEmail((String) null);
        copyObj.setPermessi(permessi);
     ...
     * @throws TorqueException if retrieval of the associated objects fails
     */
    public Dipendente copyInto(Dipendente copyObj, boolean deepcopy, Connection con) throws TorqueException
    {
        copyObj.setEmail((String) null);
        copyObj.setPermessi(permessi);
    ...
    /** The Peer class */
    private static final com.opcal.DipendentePeer peer
            = new com.opcal.DipendentePeer();
     ...
     */
    public com.opcal.DipendentePeer getPeer()
    {
        return peer;
    }
    ...
    {
        return com.opcal.DipendentePeer.getTableMap();
    }
    ...
    public boolean equals(Object toCompare)
    {
        ...
        Dipendente other = (Dipendente) toCompare;
     ...
     */
    public boolean valueEquals(Dipendente toCompare)
    {
        if (toCompare == null)
        {
            return false;
        ...
        if (this.permessi != toCompare.getPermessi())
        {
            return false;
        }
        return true;
