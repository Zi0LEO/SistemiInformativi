 ...
 * extended; all references should be to Reso
 */
@SuppressWarnings("unused")
public abstract class BaseReso 
    implements Persistent, Serializable, ColumnAccessByName
{
    /** Serial version */
    private static final long serialVersionUID = 1741873521765L;



    /** Codice della spedizione a cui il reso si riferisce */
    private String codice = null;

    /** Stato del reso */
    private String stato = null;

    /** Data di richiesta del reso */
    ...
    {
        if (com.opcal.ResoPeer.CODICE.getSqlExpression().equals(name)
            || com.opcal.ResoPeer.CODICE.getColumnName().equals(name))
        {
            return getCodice();
        }
        if (com.opcal.ResoPeer.STATO.getSqlExpression().equals(name)
            || com.opcal.ResoPeer.STATO.getColumnName().equals(name))
        {
            return getStato();
        }
        if (com.opcal.ResoPeer.DATA.getSqlExpression().equals(name)
            || com.opcal.ResoPeer.DATA.getColumnName().equals(name))
        {
            return getData();
        }
        return null;
            ...
            throws TorqueException
    {
        ...
        try
        {
            ...
            if (isModified())
            {
                if (isNew())
                {
                    ResoPeer.doInsert((Reso) this, con);
                    setNew(false);
                }
                else
                {
                    ResoPeer.doUpdate((Reso) this, con);
                }
            }
     ...
     */
    public Reso copy() throws TorqueException
    {
        return copy(true);
    }
     ...
     * @throws TorqueException if retrieval of the associated objects fails     
     */
    public Reso copy(Connection con) throws TorqueException
    {
     ...
     * @throws TorqueException if retrieval of the associated objects fails
     */
    public Reso copy(boolean deepcopy) throws TorqueException
    {
        Reso reso = new Reso();

        return copyInto(reso, deepcopy);
    }
     ...
     * @throws TorqueException if retrieval of the associated objects fails
     */
    public Reso copy(boolean deepcopy, Connection con) throws TorqueException
    {
        Reso reso = new Reso();

        return copyInto(reso, deepcopy, con);
    }
     ...
     * @throws TorqueException if retrieval of the associated objects fails
     */
    public Reso copyInto(Reso copyObj) throws TorqueException
    {
     ...
     * @throws TorqueException if retrieval of the associated objects fails
     */
    public Reso copyInto(Reso copyObj, Connection con) throws TorqueException
    {
     ...
     * @throws TorqueException if retrieval of the associated objects fails
     */
    protected Reso copyInto(Reso copyObj, boolean deepcopy) throws TorqueException
    {
     ...
     * @throws TorqueException if retrieval of the associated objects fails
     */
    public Reso copyInto(Reso copyObj, boolean deepcopy, Connection con) throws TorqueException
    {
        copyObj.setCodice((String) null);
        copyObj.setStato(stato);
        copyObj.setData(data);
    ...
    /** The Peer class */
    private static final com.opcal.ResoPeer peer
            = new com.opcal.ResoPeer();
     ...
     */
    public com.opcal.ResoPeer getPeer()
    {
        return peer;
    }
    ...
    {
        return com.opcal.ResoPeer.getTableMap();
    }
     ...
     */
    public boolean valueEquals(Reso toCompare)
    {
        if (toCompare == null)
        {
            return false;
