...
\begin{itemize}
  ...
  \item \textbf{Ricevuta}(\underline{Codice}, Stato, Importo, Data);
  ...
  \item \textbf{Prenotata}(\underline{Codice}, DataRitiro, DataSpedizione) \\\textbf{Prenotata}(Codice)$\subseteq _{FK}$\textbf{Spedizione}(Codice);
