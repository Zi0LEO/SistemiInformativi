...
\begin{enumerate}
	...
	\item{(MUST)} Accedere ai dati delle spedizioni dei clienti [Sportellista, Portalettere, Responsabili];
		\item {(MUST)}  Implementare un sistema di mailing lists[Sportellista]:
	\begin{enumerate}
		\item Poter mandare e-mail solo a un determinato gruppo di utenti;
		\item Inviare aggiornamenti sulle spedizioni tramite posta elettronica;
		\item Inviare aggiornamenti sullo stato di un appuntamento in sede;
		\item Inviare aggiornamento sullo stato di una procedura di resto.
	\end{enumerate}
\end{enumerate}
