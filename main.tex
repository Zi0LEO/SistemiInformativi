...
\begin{enumerate}
	\item L'attributo \textit{prezzo 10kg} dell'entità \textit{Corriere} è l'attributo \textit{prezzo 1kg}$*10$;
	\item L'attributo \textit{prezzo 100kg} dell'entità \textit{Corriere} è l'attributo \textit{prezzo 10kg}$*10$.
\end{enumerate}
...
\begin{table}[H]
	...
	\begin{tabularx}{\dimexpr\textwidth-15\arrayrulewidth}{|*{4}{Y|}} %sempre 15 manco io so perché
		...
		\textbf{Entità} & \textbf{Descrizione} & \textbf{Attributi} & \textbf{Identificatore} \\ \hline
		 Reso & Rappresenta i resi iniziati dai clienti & Data,stato, cliente associiato & Cliente associato \\
		 \hline
		 Cliente & Rappresenta i clienti dell'organizzazione & Nome, cognome, e-mail & E-mail \\
		\hline 
		Indirizzo & Rappresenta l'indirizzo di spedizione dei clienti & Comune, indirizzo, orario preferito & Comune, indirizzo \\ 
		\hline
		...
		\hline
		Prenotata & Rappresenta le spedizioni prenotate & Quelle dell'entità madre, data di prenotazione & Codice entità madre \\
		\hline
		Corrirere & Rappresenta i corrieri dell'organizzazione & Partita IVA, sito web, nome, telefono, prezzo 1kg, prezzo 10kg, prezzo 100kg & Partita IVA \\
		\hline 
	\end{tabularx}
\end{table}
...
\begin{table}[H]
	...
	\begin{tabularx}{\dimexpr\textwidth-15\arrayrulewidth}{|*{4}{Y|}} %sempre 15 manco io so perché
	    ...
	    \hline
	    Ritiro & Associa la spedizione di tipo prenotata all'indirizzo in cui verrà ritirata & Prenotata, Indirizzo & Data \\
	    \hline 
