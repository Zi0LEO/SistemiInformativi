...
\begin{tabularx}{\textwidth}{|*{5}{Y|}}
  ...
  \multicolumn{5}{|c|}{Approvvigionamenti(AP)} \\ 
  \hline
  \multicolumn{5}{|c|}{AP1: ordini per consumabili generici} \\ 
  \multicolumn{5}{|c|}{AP2:} \\
  \hline
  ...
  \multicolumn{5}{|c|}{GRU3: nuove assunzioni} \\
  \hline

  \multicolumn{5}{|c|}{Sviluppo tecnologie(ST)} \\ \hline
  \multicolumn{5}{|c|}{ST1:} \\
  \multicolumn{5}{|c|}{ST2:} \\
  \hline
